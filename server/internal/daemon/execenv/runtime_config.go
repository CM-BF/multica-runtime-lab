...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "codearts", "deveco", "openclaw", "openai-sandbox", "deepagents", "hermes", "pi", "cursor", "kimi", "reasonix", "dsh", "kiro", "antigravity", "qoder", "qoderclicn", "traecli", "grok", "qwenpaw", "mcode", "dim", "zeroclaw":
