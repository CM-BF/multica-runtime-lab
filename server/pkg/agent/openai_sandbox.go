...
func sandboxErrorCode(code string) string {
	switch code {
	case "INVALID_REQUEST", "INVALID_SESSION", "STATE_BUSY", "DIRTY_SESSION", "CHECKPOINT_INVALID", "ARTIFACT_CONFLICT", "UNSAFE_PATH", "FILE_LIMIT", "MCP_CONFIG", "MCP_UNREADY", "CANCELLED", "MODEL_CREDENTIALS", "MODEL_RATE_LIMIT", "MAX_TURNS", "APPROVAL_REQUIRED", "STATE_SECRET", "SDK_FAILURE", "BRIDGE_FAILURE":
		return code
	default:
		return "SDK_FAILURE"
	}
